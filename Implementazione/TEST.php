...
<head>
    ...
    <style type="text/css">
       .risposta{
        ...
        .contenitore{background:cadetblue; padding:10px; margin-right: 100px; margin-left:100px;}
        .testn{color:black;text-align: center;}
...
function testCaratteri(i){
    var stringa="";
    for(var x=1;x<=i;x++){if(x==200){stringa=stringa+"X";}else{stringa=stringa+"T";}}

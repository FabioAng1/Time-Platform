...
if(isset($_SESSION['ut'])&&isset($_SESSION['pw'])&& ( strlen($_SESSION['ut'])>0 ) && ( strlen($_SESSION['pw'])>0 ) && isset($_SESSION['controllorichiesta']) && (strcmp($_SESSION['controllorichiesta'],"ok")==0)){
	...
	printf("
			...
			<div class='form-group-stra'><div class='input-group date' id='datastra'>
			<input type='text' class='form-control-stra' />
			...
			<div class='col-sm-9'>
			<textarea class='form-control-stra' id='descrizionestra' cols='3' rows='3'>
			</textarea>
			</div>
			");
